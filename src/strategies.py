"""This module contains learning strategies to update a policy sequentially."""
...
class IPSStrategy(BaseStrategy):
    ...
    def _grad_utility(self, sample, cur_policy, sample_policy, weights=None):
        """Estimate the gradient of the objective.

        This is the gradient of the combined objective of utility and fairness
        term (if present) wrt the parameters of a logistic or semi_logistic
        policy from a given sample.
        ...
        # The difference of the benefits themselves
        benefit_difference = self._mean_difference(tmp_ben, s)
...
class PredictiveStrategy(BaseStrategy):
    """An update strategy for a thresholded predictive model."""
