...
def get_optimal_policy(opt, cost, featuremap=None):
    ...
    Basically we need to figure out whether we can compute the optimal
    deterministic policy for the given distribution analytically.
    Therefore we need a whole lot of checks for the distribution to figure this
